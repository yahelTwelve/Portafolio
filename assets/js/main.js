...
const sendEmail = (e) => {
    ...
    emailjs.sendForm("service_a3dnbif","template_u25fd39","#contact-form","lZppq2SjepLqr6q14")
    .then(() =>{
        ...
        contactMessage.textContent = "Mensaje fallido"
    })
}
...
const getCurrentIcon = () => themeButton.classList.contains(iconTheme) ? 'ri-sun-fill' : 'ri-sun-line'
...
sr.reveal(`.home__perfil, .about__image, .contact__mail`, {origin:'rigth'})
...
sr.reveal(`.projects__card`, {origin: 'top', interval: 100})